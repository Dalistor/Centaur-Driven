...
4. A spec é criada em `.centaur/specs/` e registra internamente os links para as notas humanas que a originaram; o vault não recebe uma cópia ou índice de specs.
